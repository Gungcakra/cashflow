...
$flagGoal = isset($_POST['flagGoal']) ? $_POST['flagGoal'] : '';
...
$params[] = $limit;
$params[] = $offset;
$goal = query($query, $params);
?>

<table id="goal-list-table" class="table table-striped dataTable mt-4" role="grid"
    aria-describedby="goal-list-page-info">
    <thead>
        <tr class="ligth">
            <th>#</th>
                ...
                <td>
                    ...
                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                        <!-- <a class="dropdown-item" href="#" data-toggle="tooltip" data-placement="top" title="Add">
                            <i class="ri-goal-add-line mr-0"></i> Add
                        </a> -->
                        <a class="dropdown-item" href="form/?data=<?= $row['idGoal'] ?>" data-toggle="tooltip" data-placement="top" title="Edit">
                            <i class="ri-pencil-line mr-0"></i> Edit
                        </a>
                        <a class="dropdown-item" href="#" data-toggle="tooltip" data-placement="top" title="Delete" onclick="deleteGoal(<?= $row['idGoal'] ?>)">
...
<div id="goal-list-page-info" class="col-md-6" id="pagination">
