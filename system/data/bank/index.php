                                    ...
                                    <div class="row justify-content-between">
                                        ...
                                        <div class="col-sm-6 col-md-6">
                                            <div class="user-list-files d-flex">
                                                ...
                                                <a class="btn btn-primary mr-1" href="./form/"><svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
