...
$flagBank = isset($_POST['flagBank']) ? $_POST['flagBank'] : '';
            ...
            <?php foreach ($bank as $key => $row): ?>
                ...
                <td>
                    ...
                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                        ...
                        <a class="dropdown-item" href="form/?data=<?= $row['idBank'] ?>" data-toggle="tooltip" data-placement="top" title="Edit">
                            <i class="ri-pencil-line mr-0"></i> Edit
                        </a>
                        <a class="dropdown-item" href="#" data-toggle="tooltip" data-placement="top" title="Delete" onclick="deleteBank(<?= $row['idBank'] ?>)">
